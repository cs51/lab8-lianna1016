...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    evt := List.filter (fun x -> x.id <> 0) !evt
...
let buzz_list = WEvent.add_listener newswire buzzFake ;;
...
let _ = WEvent.remove_listener newswire fnn_listener ;;
let _ = WEvent.remove_listener newswire buzz_list ;;
